...
//    cin >> numDays;
//
//    // Tạo một AttendanceManager với số lượng sinh viên và ngày đã nhập
//    AttendanceManager manager(numStudents, numDays);
//
//    // Thêm sinh viên và gán cho mỗi sinh viên một khóa học
//    for (int i = 0; i < numCourses; ++i) {
//        bool continueAddingStudents = true;
//        do {
//            string studentId, studentName;
//            cout << "Enter student ID for course " << courses[i].getCourseName() << ": ";
//            cin >> studentId;
//            cout << "Enter student name for course " << courses[i].getCourseName() << ": ";
//            cin >> studentName;
//
//            Student student(studentId, studentName);
//            manager.addStudent(student, courses[i]);
//
//            cout << "Enter 1 to add another student for course " << courses[i].getCourseName() << ", or 0 to finish: ";
//            cin >> continueAddingStudents;
